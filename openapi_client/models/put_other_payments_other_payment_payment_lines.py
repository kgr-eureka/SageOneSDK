...
class PutOtherPaymentsOtherPaymentPaymentLines(object):
    ...
    def __init__(self, ledger_account_id=None, total_amount=None, details=None, tax_rate_id=None, net_amount=None, tax_amount=None, is_purchase_for_resale=None, trade_of_asset=None, gst_amount=None, pst_amount=None, local_vars_configuration=None):  # noqa: E501
