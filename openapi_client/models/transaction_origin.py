...
class TransactionOrigin(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, path=None, links=None, due_date=None, outstanding_amount=None, currency=None, status=None, sent=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this TransactionOrigin.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this TransactionOrigin.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this TransactionOrigin.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this TransactionOrigin.  # noqa: E501
        :type: int
        """
