...
class Product(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, path=None, created_at=None, updated_at=None, deleted_at=None, item_code=None, description=None, notes=None, sales_ledger_account=None, sales_tax_rate=None, purchase_ledger_account=None, usual_supplier=None, purchase_tax_rate=None, cost_price=None, sales_prices=None, source_guid=None, purchase_description=None, active=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this Product.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this Product.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this Product.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this Product.  # noqa: E501
        :type: int
        """
