...
class StockMovement(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, path=None, links=None, created_at=None, updated_at=None, movement_number=None, date=None, cost_price=None, quantity=None, details=None, reference=None, stock_item=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this StockMovement.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this StockMovement.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this StockMovement.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this StockMovement.  # noqa: E501
        :type: int
        """
    ...
    def reference(self, reference):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                reference is not None and len(reference) > 50):
            raise ValueError("Invalid value for `reference`, length must be less than or equal to `50`")  # noqa: E501
