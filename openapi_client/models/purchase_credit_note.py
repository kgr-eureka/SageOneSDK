...
class PurchaseCreditNote(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, path=None, created_at=None, updated_at=None, links=None, editable=None, postponed_accounting=None, transaction=None, transaction_type=None, _import=None, deleted_at=None, contact=None, contact_name=None, contact_reference=None, date=None, reference=None, vendor_reference=None, notes=None, total_quantity=None, net_amount=None, tax_amount=None, total_amount=None, payments_allocations_total_amount=None, payments_allocations_total_discount=None, total_paid=None, outstanding_amount=None, currency=None, exchange_rate=None, inverse_exchange_rate=None, base_currency_net_amount=None, base_currency_tax_amount=None, base_currency_total_amount=None, base_currency_outstanding_amount=None, status=None, void_reason=None, credit_note_lines=None, tax_analysis=None, detailed_tax_analysis=None, payments_allocations=None, last_paid=None, tax_address_region=None, tax_reconciled=None, migrated=None, tax_calculation_method=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this PurchaseCreditNote.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this PurchaseCreditNote.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this PurchaseCreditNote.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this PurchaseCreditNote.  # noqa: E501
        :type: int
        """
