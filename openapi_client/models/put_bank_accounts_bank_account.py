...
class PutBankAccountsBankAccount(object):
    ...
    def __init__(self, bank_account_type_id=None, ledger_account_id=None, nominal_code=None, default_payment_method_id=None, bank_account_details=None, main_address=None, main_contact_person=None, journal_code=None, local_vars_configuration=None):  # noqa: E501
