...
class BankAccount(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, path=None, created_at=None, updated_at=None, deleted_at=None, bank_account_details=None, ledger_account=None, bank_account_type=None, balance=None, main_address=None, main_contact_person=None, nominal_code=None, editable=None, deletable=None, journal_code=None, default_payment_method=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this BankAccount.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this BankAccount.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this BankAccount.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this BankAccount.  # noqa: E501
        :type: int
        """
