...
class FinancialSettings(object):
    ...
    def __init__(self, path=None, year_end_date=None, year_end_lockdown_date=None, accounting_type=None, accounts_start_date=None, base_currency=None, multi_currency_enabled=None, use_live_exchange_rates=None, mtd_activation_status=None, mtd_connected=None, mtd_authenticated_date=None, tax_scheme=None, tax_return_frequency=None, tax_number=None, general_tax_number=None, tax_office=None, default_irpf_rate=None, flat_rate_tax_percentage=None, sales_tax_calculation=None, purchase_tax_calculation=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
