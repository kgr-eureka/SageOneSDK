...
class ContactPayment(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, path=None, created_at=None, updated_at=None, links=None, transaction=None, transaction_type=None, deleted_at=None, payment_method=None, contact=None, bank_account=None, date=None, net_amount=None, tax_amount=None, total_amount=None, currency=None, exchange_rate=None, base_currency_net_amount=None, base_currency_tax_amount=None, base_currency_total_amount=None, base_currency_currency_charge=None, reference=None, allocated_artefacts=None, tax_rate=None, payment_on_account=None, editable=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this ContactPayment.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this ContactPayment.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this ContactPayment.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this ContactPayment.  # noqa: E501
        :type: int
        """
