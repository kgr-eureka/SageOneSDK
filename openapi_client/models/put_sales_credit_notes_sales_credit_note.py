...
class PutSalesCreditNotesSalesCreditNote(object):
    ...
    def __init__(self, contact_id=None, date=None, credit_note_number_prefix=None, credit_note_number=None, contact_name=None, contact_reference=None, reference=None, notes=None, terms_and_conditions=None, shipping_net_amount=None, shipping_tax_rate_id=None, shipping_tax_amount=None, total_quantity=None, shipping_total_amount=None, net_amount=None, tax_amount=None, total_amount=None, currency_id=None, exchange_rate=None, inverse_exchange_rate=None, base_currency_shipping_net_amount=None, base_currency_shipping_tax_amount=None, base_currency_shipping_total_amount=None, total_discount_amount=None, base_currency_total_discount_amount=None, base_currency_net_amount=None, base_currency_tax_amount=None, base_currency_total_amount=None, status_id=None, sent=None, tax_address_region_id=None, main_address=None, delivery_address=None, credit_note_lines=None, tax_analysis=None, local_vars_configuration=None):  # noqa: E501
