...
class PurchaseCreditNoteLineItem(object):
    ...
    def __init__(self, legacy_id=None, id=None, displayed_as=None, is_purchase_for_resale=None, description=None, product=None, service=None, ledger_account=None, trade_of_asset=None, quantity=None, unit_price=None, net_amount=None, tax_rate=None, tax_amount=None, tax_breakdown=None, total_amount=None, base_currency_unit_price=None, unit_price_includes_tax=None, base_currency_net_amount=None, base_currency_tax_amount=None, base_currency_tax_breakdown=None, base_currency_total_amount=None, eu_goods_services_type=None, gst_amount=None, pst_amount=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def legacy_id(self):
        """Gets the legacy_id of this PurchaseCreditNoteLineItem.  # noqa: E501

        The legacy ID for the item  # noqa: E501

        :return: The legacy_id of this PurchaseCreditNoteLineItem.  # noqa: E501
        :rtype: int
        """
    ...
    def legacy_id(self, legacy_id):
        """Sets the legacy_id of this PurchaseCreditNoteLineItem.

        The legacy ID for the item  # noqa: E501

        :param legacy_id: The legacy_id of this PurchaseCreditNoteLineItem.  # noqa: E501
        :type: int
        """
