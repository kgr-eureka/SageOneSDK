...
class LedgerAccountsApi(object):
    ...
    def get_ledger_accounts(self, **kwargs):  # noqa: E501
        ...
        :param bool show_legacy_id: Display the legacy_id for the Ledger Accounts.
    ...
    def get_ledger_accounts_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['updated_or_created_since', 'visible_in', 'not_visible_in', 'show_included_in_chart', 'show_control_accounts', 'ledger_account_classification_id', 'show_balance_details', 'exclude_deleted_entries', 'from_date', 'to_date', 'search', 'sort_order_from_user_setting', 'show_legacy_id', 'items_per_page', 'page', 'attributes', 'ledger_account_type_id']  # noqa: E501
    ...
    def get_ledger_accounts_key(self, key, **kwargs):  # noqa: E501
        ...
        :param datetime from_date: Calculate balances from this date.
        :param datetime to_date: Calculate balances to this date.
        :param bool show_legacy_id: Display the legacy_id for the Ledger Account.
    ...
    def get_ledger_accounts_key_with_http_info(self, key, **kwargs):  # noqa: E501
        ...
        all_params = ['key', 'nested_attributes', 'show_balance_details', 'exclude_deleted_entries', 'from_date', 'to_date', 'show_legacy_id', 'attributes']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_ledger_accounts(self, ledger_accounts, **kwargs):  # noqa: E501
        ...
        Creates a Ledger Account  ### Endpoint Availability  * Accounting: 🇨🇦, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any mentioned role in one of the listed areas: * Area: `Settings`: Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_ledger_accounts_with_http_info(self, ledger_accounts, **kwargs):  # noqa: E501
        ...
        all_params = ['ledger_accounts']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_ledger_accounts_key(self, key, ledger_accounts, **kwargs):  # noqa: E501
        ...
        Updates a Ledger Account  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any mentioned role in one of the listed areas: * Area: `Settings`: Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def put_ledger_accounts_key_with_http_info(self, key, ledger_accounts, **kwargs):  # noqa: E501
        ...
        all_params = ['key', 'ledger_accounts']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
