...
class SalesEstimatesApi(object):
    ...
    def delete_sales_estimates_key(self, key, **kwargs):  # noqa: E501
        ...
        Deletes a Sales Estimate  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access  # noqa: E501
    ...
    def get_sales_estimates(self, **kwargs):  # noqa: E501
        ...
        Returns all Sales Estimates  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Read Only, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool show_legacy_id: Display the legacy_id for the Sales Estimates.
    ...
    def get_sales_estimates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['contact_id', 'search', 'status_id', 'from_date', 'to_date', 'updated_or_created_since', 'has_attachments', 'show_legacy_id', 'items_per_page', 'page', 'attributes']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_sales_estimates_key(self, key, **kwargs):  # noqa: E501
        ...
        Returns a Sales Estimate  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Read Only, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool show_legacy_id: Display the legacy_id for the Sales Estimate.
    ...
    def post_sales_estimates(self, sales_estimates, **kwargs):  # noqa: E501
        ...
        Creates a Sales Estimate  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_sales_estimates_with_http_info(self, sales_estimates, **kwargs):  # noqa: E501
        ...
        all_params = ['sales_estimates']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_sales_estimates_key(self, key, sales_estimates, **kwargs):  # noqa: E501
        ...
        Updates a Sales Estimate  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇫🇷, 🇮🇪, 🇬🇧, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def put_sales_estimates_key_with_http_info(self, key, sales_estimates, **kwargs):  # noqa: E501
        ...
        all_params = ['key', 'sales_estimates']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
