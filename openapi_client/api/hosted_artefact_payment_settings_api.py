...
class HostedArtefactPaymentSettingsApi(object):
    ...
    def delete_hosted_artefact_payment_settings_key(self, key, **kwargs):  # noqa: E501
        ...
        Deletes a Hosted Artefact Payment Setting  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access  # noqa: E501
    ...
    def get_hosted_artefact_payment_settings(self, **kwargs):  # noqa: E501
        ...
        Returns all Hosted Artefact Payment Settings  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Read Only, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool show_legacy_id: Display the legacy_id for the Hosted Artefact Payment Settings.
    ...
    def get_hosted_artefact_payment_settings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['object_guid', 'show_legacy_id', 'items_per_page', 'page', 'attributes']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_hosted_artefact_payment_settings_key(self, key, **kwargs):  # noqa: E501
        ...
        Returns a Hosted Artefact Payment Setting  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Read Only, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str key: The Hosted Artefact Payment Setting Key. (required)
        :param bool show_legacy_id: Display the legacy_id for the Hosted Artefact Payment Setting.
    ...
    def post_hosted_artefact_payment_settings(self, hosted_artefact_payment_settings, **kwargs):  # noqa: E501
        ...
        Creates a Hosted Artefact Payment Setting  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Sales`: Full Access, Restricted Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_hosted_artefact_payment_settings_with_http_info(self, hosted_artefact_payment_settings, **kwargs):  # noqa: E501
        ...
        all_params = ['hosted_artefact_payment_settings']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
