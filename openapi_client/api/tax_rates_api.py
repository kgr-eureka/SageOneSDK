...
class TaxRatesApi(object):
    ...
    def delete_tax_rates_key(self, key, **kwargs):  # noqa: E501
        ...
        Deletes a Tax Rate (US only)  ### Access Control Restrictions  Requires the authenticated user to have any mentioned role in one of the listed areas: * Area: `Settings`: Full Access  # noqa: E501
    ...
    def get_tax_rates(self, **kwargs):  # noqa: E501
        ...
        :param bool show_legacy_id: Display the legacy_id for the Tax Rates.
    ...
    def get_tax_rates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['updated_or_created_since', 'address_region_id', 'date', 'include_historical_data', 'show_legacy_id', 'items_per_page', 'page', 'attributes']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_tax_rates_key(self, key, **kwargs):  # noqa: E501
        ...
        :param bool show_legacy_id: Display the legacy_id for the Tax Rate.
    ...
    def get_tax_rates_key_with_http_info(self, key, **kwargs):  # noqa: E501
        ...
        all_params = ['key', 'date', 'show_legacy_id', 'attributes']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_tax_rates(self, tax_rates, **kwargs):  # noqa: E501
        ...
        Creates a Tax Rate (US only)  ### Access Control Restrictions  Requires the authenticated user to have any mentioned role in one of the listed areas: * Area: `Settings`: Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def put_tax_rates_key(self, key, tax_rates, **kwargs):  # noqa: E501
        ...
        Updates a Tax Rate (US only)  ### Access Control Restrictions  Requires the authenticated user to have any mentioned role in one of the listed areas: * Area: `Settings`: Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def put_tax_rates_key_with_http_info(self, key, tax_rates, **kwargs):  # noqa: E501
        ...
        all_params = ['key', 'tax_rates']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
