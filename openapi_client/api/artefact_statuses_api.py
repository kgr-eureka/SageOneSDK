...
class ArtefactStatusesApi(object):
    ...
    def get_artefact_statuses(self, **kwargs):  # noqa: E501
        ...
        Returns all Artefact Statuses  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  # noqa: E501
        ...
        :param bool show_legacy_id: Display the legacy_id for the Artefact Statuses.
    ...
    def get_artefact_statuses_key(self, key, **kwargs):  # noqa: E501
        ...
        Returns a Artefact Status  ### Endpoint Availability  * Accounting: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool show_legacy_id: Display the legacy_id for the Artefact Status.
