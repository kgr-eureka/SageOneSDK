...
from openapi_client.models.put_sales_estimates import PutSalesEstimates  # noqa: E501
...
class TestPutSalesEstimates(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.put_sales_estimates.PutSalesEstimates()  # noqa: E501
        if include_optional :
            return PutSalesEstimates(
                sales_estimate = openapi_client.models.put_sales_estimates_sales_estimate.putSalesEstimates_sales_estimate(
                    contact_id = '0', 
                    ...
                    delivery_address = openapi_client.models.post_sales_corrective_invoices_sales_corrective_invoice_main_address.postSalesCorrectiveInvoices_sales_corrective_invoice_main_address(
                        ...
                        country_group_id = '0', ), 
                    estimate_lines = [
                        openapi_client.models.put_sales_estimates_sales_estimate_estimate_lines.putSalesEstimates_sales_estimate_estimate_lines(
                            description = '0', 
                            ledger_account_id = '0', 
                            quantity = 1.337, 
                            unit_price = 1.337, 
